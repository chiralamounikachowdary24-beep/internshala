...
const getInternshipDuration = (internship: any) =>
  internship.duration || internship.Duration || "Duration TBD";

const getJobExperience = (job: any) =>
  job.Experience || job.experience || "Experience TBD";
        ...
        {filteredInternships.map((internship: any, index: any) => (
          ...
          >
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <div className="flex items-center gap-2">
                <Calendar size={18} />
                <span>{getInternshipDuration(internship)}</span>
              </div>
            </div>
